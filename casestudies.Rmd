...
You can obtain the retail prices (relevant for the demand equations) by applying the taxes to the wholesale prices. Before considering any options to reform the tax system, you must calculate the current tax expenditures and effective tax rates to obtain a baseline. You are considering various options to reform the tax system to make the overall taxes more regressive:
...
- The revenue generated across all three taxes cannot decrease. That is, the state is providing services that are paid for by the tax revenue. 
